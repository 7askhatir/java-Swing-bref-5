...
public class Bref5 implements ActionListener {
    ...
    String[] Question= { "JAVA est un langage",
                         ...
                         "JAVA, il se transforme en programme en bytecode Quelle est l’extension du programme en bytecode ?",
                         "Class Test",
    ...
    Bref5(int a){
        ...
        next.setBounds(535, 510, 100, 100);
        next.setFont(new Font("MV BOLI",Font.BOLD,25));
        next.addActionListener(this);
        next.setText("Next");
        
        next2.setBounds(0, 510, 100, 100);
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        switch(str){
            ...
            case "Fin" : JOptionPane.showMessageDialog(null, "Congratulation" , "InfoBox: ", JOptionPane.INFORMATION_MESSAGE);
